        ...
        <>
            ...
            <div className='container'>
                <div className='secondplace'>
                    ...
                    <div className='secondtext te'> <h2 className='heading '>How to Reach Indore </h2>
                        <h3> <i class='fas fa-map-marker-alt'></i> Indore , Madhya Pradesh , India </h3>
            ...
            <div className='container my-5'>
               ...
               <div className='container'>
                ...
                <a class="btn btn-primary my-4" href='https://www.air.irctc.co.in/' target='_blank'
                ...
                <a class="btn btn-primary my-4" href="https://www.bus.irctc.co.in/home" target='_blank'
                style={{  fontSize : "1.2rem" ,}} 
                ...
                <a class="btn btn-primary my-4" href="https://www.irctc.co.in/nget/train-search" target='_blank'
                style={{  fontSize : "1.2rem" ,}} 
                ...
                <a class="btn btn-primary my-4" href='https://chalo.com/indore' target='_blank'
                style={{  fontSize : "1.2rem" ,}} 
